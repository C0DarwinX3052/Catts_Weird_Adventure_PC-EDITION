...
function setup(){
  ...
  //Start
  sb = createSprite(600, 400);
  sb.visible = false;

  //Button
  button = createSprite(0, 0);
  button.visible = false

  //Sprites
  p1 = createSprite(600, 300, 25, 25);
  p1.addImage(player);


  //Obystacles
  //Vertical
  o1 = createSprite(0, 0, 50, 200);
  o2 = createSprite(0, 0, 50, 200);
  o3 = createSprite(0, 0, 50, 200);
  o4 = createSprite(0, 0, 50, 200);
  //Horizontal
  o5 = createSprite(0, 0, 200, 50);
  o6 = createSprite(0, 0, 200, 50);
  o7 = createSprite(0, 0, 200, 50);
  o8 = createSprite(0, 0, 200, 50);


  //Doors
  d1 = createSprite(0, 0, 100, 25);
  d2 = createSprite(0, 0, 25, 100);
  d3 = createSprite(0, 0, 25, 100);
  ...
  w3 = createSprite(1200, 400, 100, 1000);
  w4 = createSprite(700, 700, 1400, 100);
...
function draw(){
  ...
  if (gs === 0){
    ...
    fill("black");
    textSize(64);
    text("CATT's Weird Dimension", 215, 200);
    textSize(24);
    text("(C)DarwinX3052 2021", 475, 250);
    textSize(48);
    text("Start", 550, 400);
...
if (room === 9){
  ...
  if (debugToggle === 'on'){
    textSize(14);
    text("P1_PositionX=" + p1.x, 100, 100);
    text("P1_PositionY=" + p1.y, 100, 125);
    text("P1_Lives=" + lives, 100, 150);
    text("P1_Level=" + level, 100, 175);
    text("P1_XP=" + xp, 100, 200);
    text("GameState=" + gs, 100, 250);
    text("Room=" + room, 100, 275);
    text("DebugToggle=" + debugToggle, 100, 300);
    text("DarwinX3052 Games 2021", 100, 675);
    text("FrameCount=" + frameCount, 100, 325);
    text("Number=" + round(random(1,100)), 100, 350);
    text("Touches=" + touches, 100, 375);
    text("Sound_Play?=" + splay, 100, 400);

    text("NEWLY ADDED", 100, 500);
    text("Boss_Life=" + bosslife, 100, 550);
